...
export class ParentService {
   ...
   * @throws ApiError
   */
  public static parentCheckCreate(data: ParentCheckSms): CancelablePromise<ParentCheckSms> {
   ...
   * @throws ApiError
   */
  public static parentCreateCreate(data: ParentCreate): CancelablePromise<ParentCreate> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/parent/create/',
      body: data,
   ...
   * @throws ApiError
   */
  public static parentDeleteNowRead(guid: string): CancelablePromise<ParentList> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static parentDeleteNowDelete(guid: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/parent/delete/{guid}/now/',
      path: {
   ...
   * @throws ApiError
   */
  public static parentDetailNowRead(guid: string | number): CancelablePromise<ParentDetail> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static parentLoginCreate(data: ParentLogin): CancelablePromise<ParentLogin> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/parent/login/',
      body: data,
   ...
   * @throws ApiError
   */
  public static parentProfileDetailNowRead(guid: string): CancelablePromise<ParentProfileList> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static parentProfileUpdateNowRead(guid: string): CancelablePromise<ParentProfileUpdate> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static parentSignupCreate(data: ParentSignUp): CancelablePromise<ParentSignUp> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/parent/signup/',
      body: data,
   ...
   * @throws ApiError
   */
  public static parentUpdateNowRead(guid: string): CancelablePromise<ParentUpdate> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static parentUpdateNowUpdate(guid: string, data: ParentUpdate): CancelablePromise<ParentUpdate> {
    return __request(OpenAPI, {
      method: 'PUT',
      url: '/parent/update/{guid}/now/',
      path: {
   ...
   * @throws ApiError
   */
  public static parentUpdateNowPartialUpdate(guid: string, data: ParentUpdate): CancelablePromise<ParentUpdate> {
    return __request(OpenAPI, {
      method: 'PATCH',
      url: '/parent/update/{guid}/now/',
      path: {
